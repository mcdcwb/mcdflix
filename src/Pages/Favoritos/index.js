...
function Favoritos() {
    ...
    return(
        <div className="meus-filmes">
            ...
            {filmes.length === 0 && <span className="spam-empty">Você não possui nenhum filme salvo no momento. <img width="100" height="100" src="https://img.icons8.com/quill/100/f26c4f/sad.png" alt="sad"/></span>}
